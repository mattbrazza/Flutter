...
module.exports.loginUserCheck = function(loginReq, callback){
...
module.exports.readUserByName = function(userReq, callback){
...
module.exports.followUser = function(request, callback){
  ...
  let updateSet = { '_following': request.profile_id };
